...
//  private:
    ...
    //bool MC36XXreadRegisterBit(uint8_t reg, uint8_t pos);
	uint8_t MC36XXreadRegister8(uint8_t reg);
    //int16_t MC36XXreadRegister16(uint8_t reg);
    void MC36XXreadRegisters(uint8_t reg, uint8_t *buffer, uint8_t len);    
    //void MC36XXwriteRegisterBit(uint8_t reg, uint8_t pos, bool state);
	void MC36XXwriteRegister8(uint8_t reg, uint8_t value);
	//void MC36XXwriteRegister16(uint8_t reg, int16_t value);
// };
#endif
